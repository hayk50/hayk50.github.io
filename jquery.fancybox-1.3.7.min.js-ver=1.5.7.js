...
t.fn.fancybox=function(e){return t(this).length?(t(this).data("fancybox",t.extend({},e,t.metadata?t(this).metadata():{})).off("http://684222.ru/wp-content/plugins/easy-fancybox/fancybox/click.fb").on("http://684222.ru/wp-content/plugins/easy-fancybox/fancybox/click.fb",function(e){if(e.preventDefault(),!A){A=!0,t(this).blur(),u=[],g=0
...
if(E(),t(c.add(s).add(h)).hide(),t(d.add(n)).off(),t(window).off("http://684222.ru/wp-content/plugins/easy-fancybox/fancybox/resize.fb scroll.fb mousewheel.fb"),t(document).off("http://684222.ru/wp-content/plugins/easy-fancybox/fancybox/keydown.fb"),d.find("iframe#fancybox-frame").attr("src",S&&/^https/i.test(window.location.href||"")?"javascript:void(false)":"about:blank"),"inside"!==w.titlePosition&&r.empty(),a.stop(),"elastic"==w.transitionOut){f=U()
var i=a.position()
